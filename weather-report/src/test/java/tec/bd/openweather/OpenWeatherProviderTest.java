...
public class OpenWeatherProviderTest {
    ...
    public void GivenZipCode_WhenOpenWeatherRemoteCall_ThenGetReport() throws Exception {
        try (MockWebServer server = new MockWebServer()) {
            ...
            OpenWeatherAPIProvider openWeatherAPIProvider = mock(OpenWeatherAPIProvider.class);

            given(openWeatherAPIProvider.getAPIKey()).willReturn("the-api-key");

            var openWeatherService = new OpenWeatherProvider(openWeatherResource, openWeatherAPIProvider);
            ...
            verify(openWeatherAPIProvider, times(1)).getAPIKey();
